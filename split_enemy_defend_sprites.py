#!/usr/bin/env python3
"""
Slice enemy defend sprite sheets (3x3 grids) into individual frame folders.
Source: assets/sprites/battle/enemy defend/
...
SOURCE_DIR = os.path.join(BASE_DIR, "assets", "sprites", "battle", "enemy defend")
FRAMES_DIR = os.path.join(BASE_DIR, "assets", "sprites", "battle", "frames")

SPRITE_MAP = {
    "goblin_defend.png":      "goblin_defend",
    "golem_defend.png":       "golem_defend",
    "wraith_defend.png":      "wraith_defend",
    "dark knight defend.png": "dark_knight_defend",
}
...
def main():
    print("=" * 50)
    print("Enemy Defend Sheet Splitter")
    print("=" * 50)
